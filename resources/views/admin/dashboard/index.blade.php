...
@section('content')
  ...
  <div class="flex flex-wrap -mx-4 mb-6">
    ...
    <div class="w-full md:w-1/3 px-4 mb-4">
      <x-dashboard.card title="方案数" count="3" href-title="管理方案">
        <x-slot name="icon">
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="w-full md:w-1/3 px-4 mb-4">
      <x-dashboard.card title="分组数" count="1" href-title="管理分组">
        <x-slot name="icon">
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="w-full md:w-1/3 px-4 mb-4">
      <x-dashboard.card title="卡片数" count="0" href-title="管理卡片">
        <x-slot name="icon">
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    <div class="w-full md:w-1/3 px-4 mb-4">
      <x-dashboard.card title="页面数" count="0" href-title="管理页面">
        <x-slot name="icon">
          <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
