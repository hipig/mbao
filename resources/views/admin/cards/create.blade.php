    ...
    <x-form action="{{ route('admin.cards.store') }}">
      ...
      <div class="grid grid-cols-6 gap-x-6">
        <div class="col-span-6 sm:col-span-2">
          <x-form.input label="中文发音" name="spell_cn" placeholder="请输入中文发音"></x-form.input>
        </div>
        <div class="col-span-6 sm:col-span-2">
          <x-form.input label="美式发音" name="spell_us" placeholder="请输入美式发音"></x-form.input>
        </div>
        <div class="col-span-6 sm:col-span-2">
          <x-form.input label="英式发音" name="spell_uk" placeholder="请输入英式发音"></x-form.input>
        </div>
      </div>
